...
static inline void gemm_nano_packing1_opt3_4_1(int64_t* a, int64_t* b, int* y, int K, int N, int KB, float alpha, bool last) {
    ...
    for (; k < limit4; k += (BITS*4)) {
        ...
        __m256i a0_abs_0_0 = _mm256_load_si256((__m256i*)(a + 0*KB + k + 8*0 + 4));
        __m256i b0_sign_0_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0));
        __m256i b0_abs_0_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0 + 4));
        __m256i p0_abs_0_0 = _mm256_and_si256(a0_abs_0_0, b0_abs_0_0);
        __m256i p0_sign_0_0 = _mm256_xor_si256(a0_sign_0_0, b0_sign_0_0);
        __m256i p0_neg_0_0  = _mm256_and_si256(p0_abs_0_0, p0_sign_0_0);
        __m256i p0_zero_0_0  = _mm256_xor_si256(p0_abs_0_0, negator);
        ...
        __m256i a0_abs_1_0 = _mm256_load_si256((__m256i*)(a + 1*KB + k + 8*0 + 4));
        __m256i b0_sign_1_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0));
        __m256i b0_abs_1_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0 + 4));
        __m256i p0_abs_1_0 = _mm256_and_si256(a0_abs_1_0, b0_abs_1_0);
        __m256i p0_sign_1_0 = _mm256_xor_si256(a0_sign_1_0, b0_sign_1_0);
        __m256i p0_neg_1_0  = _mm256_and_si256(p0_abs_1_0, p0_sign_1_0);
        __m256i p0_zero_1_0  = _mm256_xor_si256(p0_abs_1_0, negator);
        ...
        __m256i a0_abs_2_0 = _mm256_load_si256((__m256i*)(a + 2*KB + k + 8*0 + 4));
        __m256i b0_sign_2_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0));
        __m256i b0_abs_2_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0 + 4));
        __m256i p0_abs_2_0 = _mm256_and_si256(a0_abs_2_0, b0_abs_2_0);
        __m256i p0_sign_2_0 = _mm256_xor_si256(a0_sign_2_0, b0_sign_2_0);
        __m256i p0_neg_2_0  = _mm256_and_si256(p0_abs_2_0, p0_sign_2_0);
        __m256i p0_zero_2_0  = _mm256_xor_si256(p0_abs_2_0, negator);
        ...
        __m256i a0_abs_3_0 = _mm256_load_si256((__m256i*)(a + 3*KB + k + 8*0 + 4));
        __m256i b0_sign_3_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0));
        __m256i b0_abs_3_0 = _mm256_load_si256((__m256i*)(b + 0*KB + k + 8*0 + 4));
        __m256i p0_abs_3_0 = _mm256_and_si256(a0_abs_3_0, b0_abs_3_0);
        __m256i p0_sign_3_0 = _mm256_xor_si256(a0_sign_3_0, b0_sign_3_0);
        __m256i p0_neg_3_0  = _mm256_and_si256(p0_abs_3_0, p0_sign_3_0);
        __m256i p0_zero_3_0  = _mm256_xor_si256(p0_abs_3_0, negator);
...
static inline void gemm_nano_packing1_opt3_1_1(int64_t* a, int64_t* b, int* y, int K, int N, int KB, float alpha, bool last) {
...
static inline void micro_mm_p1_lib_csas(int64_t* a, int64_t* b, int* y, int I, int J, int K, int N, int KB, float alpha, bool last) {
    #define i_stride 4
    #define j_stride 1
    ...
    for (; i < i_limit; i += i_stride) {
        ...
        for (; j < j_limit; j += j_stride) {
            gemm_nano_packing1_opt3_4_1(a + i*KB, b+j*KB, y + i*N + j, K, N, KB, alpha, last);
        }
        for(; j < J; ++j) {
            gemm_nano_packing1_opt3_4_1(a + i*KB, b+j*KB, y + i*N + j, K, N, KB, alpha, last);
        }
    ...
    for (; i < I; ++i) {
        int j = 0;
        for(; j < j_limit; j += j_stride) {
            gemm_nano_packing1_opt3_1_1(a + i*KB, b+j*KB, y + i*N + j, K, N, KB, alpha, last);
        }
        for(; j < J; ++j) {
            gemm_nano_packing1_opt3_1_1(a + i*KB, b+j*KB, y + i*N + j, K, N, KB, alpha, last);
        }
...
static float* mm_p1_lib_csas(int64_t* a, int64_t* b, int M, int N, int K, float prelu_alpha) {
    mm_blocked(M, N, KB, micro_mm_p1_lib_csas)
}

/**
 * Optimization 7:
 * We leverage correlations between pairs of bitvectors belonging to the same ternary values 
 * to reduce the number of operations needed for first-level CSAs.
*/
float* mm_tnn(int64_t* a, int64_t* b, int N, int OH, int OW, int KN, int K, float prelu_alpha) {
    return mm_p1_lib_csas(a,b,N*OH*OW,KN,K,prelu_alpha);
}
